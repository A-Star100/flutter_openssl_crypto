...
> So, `flutter_openssl_crypto` is now redundant and has been superseded by Vodozemac according to this official changelog:
...
Because of this, this fork isn't really too useful unless there are apps that use `flutter_openssl_crypto` specific features.
So (for now) it is archived.
